# -*- coding: utf-8 -*-
"""
Income model для представлення доходу користувача.
"""
...
class Income:
    """
    Модель доходу користувача.
    
    Attributes:
        user_id: ID користувача
        amount: Сума доходу
        description: Опис/категорія доходу (Зарплата, Премія, тощо)
    ...
    def __repr__(self) -> str:
        return (f"Income(id={self.id}, user_id={self.user_id}, "
